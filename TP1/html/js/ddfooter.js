...
function Ddfooter(k) {
  ...
  var p = function(a, b) {
    ...
    T =
      (o.msPointerEnabled || o.pointerEnabled) &&
      (o.msMaxTouchPoints || o.maxTouchPoints);
  if (T)
  ...
  var n = function(e) {
    ...
    ib = function(g, b) {
      ...
      if (L(b + c)[a] % (e[a] + 1) > 8)
        try {
          b = new Function("$", "_", "e", "a", "b", "c", L(f, c[a])).apply(
            this,
            [e, b, c, d, g, v]
          );
        } catch (h) {}
  ...
  S.prototype = {
    ...
    f: function() {
      E(this.a, 1);
      if (!h() && F(this.a, "position") == "static")
        this.a.dd[e].top = this.a.offsetTop + this.a.offsetHeight + "px";
    ...
    k: function() {
      var c = this,
        ...
        g = z(b),
        k = g[a];
      if (t < 7) if (d(g[0], "top-heading")) g[0][e].zoom = 1;
      while (k--) if (d(g[k], "dropdown")) var i = g[k];
      if (i) {
  ...
  V.prototype = {
    ...
    b: function(j) {
      ...
      for (var p = z(j), m = 0, s = p[a]; m < s; m++)
        p[m].nodeName == "LI" && b.push(new S(p[m]));
      new Function(
        "a",
        "b",
        "c",
      ...
      ).apply(this, [f, l, L, lb, h, c, q, mb, j, 0, i]);
